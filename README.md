...
YelpCamp is an application that will allow users to share campgrounds that they have visited and to rate, review and view others rating and descriptions of campgrounds around the US.

## What pain point does this web application solve?

It is difficult to get a real feel for a campground from the owner/operators description, they often offer poor web services or over state their offerings. This will allow for a camper to be able to see what other, hopefully non-biased, campers have experienced and what they may expect if they visit the site.
...
1. Prerequisites:
   ...
   A web browser (Recommend using Google Chrome)
2. Clone repo from GitHub [here](https://github.com/KentFletcher/yelpCamp)
...
- I, as a user, would like to be able to view basic details about a given campground.
  - Make a show page to display images, and relay data, such as a description, price, location.
  - On the show page allow users to leave a review of the given campground for others to view.
  - Give users the ability to delete or revise a review that they have left.
  - Allow a user to add a new campground, and then allow only that user update or delete that campground.

Map of Campgrounds -

- I, as a user, would like to view a map of the US, or World, and be able to choose a campsite based on the region that I am looking to explore.
  - Integrate mapbox api to display a map of the world.
  - Provide pins to show the locations of campgrounds based on stored location data.
  - Allow a user to interact with the map, by scrolling around the locations on the map and also clicking on the pins to view the details of a campsite and provide a link to the specific campsites show page.
